...
from models_graph.graph.sagc import SAGC

#defines graph convolution layers used in GCAE
#Supports different graph convolution types:
#sagc: Spatial Attention Graph Convolution (SAGC)
...
class ConvTemporalGraphical(nn.Module):
    ...
    #Applies graph convolution using adjacency matrices.
    #Uses Einstein summation (einsum) to apply adjacency matrices efficiently.
